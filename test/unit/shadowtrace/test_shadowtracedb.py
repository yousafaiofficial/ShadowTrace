# test_shadowtracedb.py
import pytest
import unittest

from shadowtrace import ShadowTraceDb, ShadowTraceEvent


@pytest.mark.usefixtures
class TestShadowTraceDb(unittest.TestCase):
    """
    Test ShadowTraceDb
    """
    ...
    def test_init_should_create_ShadowTraceDb_object(self):
        """
        Test __init__(self, opts, init=False)
        """
        sfdb = ShadowTraceDb(self.default_options, False)
        self.assertIsInstance(sfdb, ShadowTraceDb)
    ...
    def test_scanEventStore_should_store_a_scan_event(self):
        ...
        module = ''
        source_event = ''
        event = ShadowTraceEvent(event_type, event_data, module, source_event)
        instance_id = "example instance id"
