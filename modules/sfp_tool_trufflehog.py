...
# Purpose:     ShadowTrace plug-in for using the trufflehog tool.
...
from shadowtrace import ShadowTracePlugin, ShadowTraceEvent


class sfp_tool_trufflehog(ShadowTracePlugin):
    ...
    def handleEvent(self, event):
        ...
        for row in stdout.split("\n"):
            ...
            evt = ShadowTraceEvent('PASSWORD_COMPROMISED', descr, self.__name__, event)
