...
class ShadowTraceEvent():
    """ShadowTraceEvent object representing identified data and associated meta data.
    ...
    Attributes:
        ...
        sourceEvent (ShadowTraceEvent): ShadowTraceEvent that triggered this event
        sourceEventHash (str): Hash of the ShadowTraceEvent event that triggered this event
    ...
    def __init__(self, eventType: str, data: str, module: str, sourceEvent: 'ShadowTraceEvent') -> None:
        """Initialize ShadowTrace event object.

        Args:
            eventType (str): Event type, e.g. URL_FORM, RAW_DATA, etc.
            data (str): Event data, e.g. a URL, port number, webpage content, etc.
            module (str): Module from which the event originated
            sourceEvent (ShadowTraceEvent): ShadowTraceEvent event that triggered this event
        """
    ...
    @property
    def sourceEvent(self) -> 'ShadowTraceEvent':
    ...
    @sourceEvent.setter
    def sourceEvent(self, sourceEvent: 'ShadowTraceEvent') -> None:
        """Source event which lead to this event.

        Args:
            sourceEvent (ShadowTraceEvent): source event
        ...
        if not isinstance(sourceEvent, ShadowTraceEvent):
            raise TypeError(f"sourceEvent is {type(sourceEvent)}; expected ShadowTraceEvent()")
