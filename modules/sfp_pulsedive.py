...
class sfp_pulsedive(ShadowTracePlugin):
    ...
    def query(self, qry):
        ...
        res = self.sf.fetchUrl(url, timeout=30, useragent="ShadowTrace")
    ...
    def handleEvent(self, event):
        ...
        for addr in qrylist:
            ...
            if attributes:
                ...
                if ports:
                    for p in ports:
                        e = ShadowTraceEvent('TCP_PORT_OPEN', addr + ':' + p, self.__name__, event)
