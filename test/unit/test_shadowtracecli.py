# test_shadowtracecli.py
import io
import pytest
import sys
import unittest

from sfcli import ShadowTraceCli


@pytest.mark.usefixtures
class TestShadowTraceCli(unittest.TestCase):
    """
    Test TestShadowTraceCli
    """
    ...
    def test_do_debug_should_toggle_debug(self):
        ...
        """
        sfcli = ShadowTraceCli(self.cli_default_options)
