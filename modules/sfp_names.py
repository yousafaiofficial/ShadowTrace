...
class sfp_names(ShadowTracePlugin):
    ...
    def setup(self, sfc, userOpts=dict()):
        ...
        self.d = ShadowTraceHelpers.dictionaryWordsFromWordlists()
        self.n = ShadowTraceHelpers.humanNamesFromWordlists()
    ...
    def handleEvent(self, event):
        ...
        if eventName == "EMAILADDR" and self.opts['emailtoname']:
            ...
            evt = ShadowTraceEvent("HUMAN_NAME", name, self.__name__, event)
