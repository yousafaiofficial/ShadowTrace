...
# -------------------------------------------------------------------------------
# Name:         sflib
# Purpose:      Common functions used by ShadowTrace modules.
#
...
class ShadowTrace:
    ...
    Attributes:
        ...
        scanId (str): scan ID this instance of ShadowTrace is being used in
    ...
    def scanId(self, scanId: str) -> str:
        """Set the scan ID this instance of ShadowTrace is being used in.
    ...
    def cachePut(self, label: str, data: str) -> None:
        ...
        cacheFile = ShadowTraceHelpers.cachePath() + "/" + pathLabel
    ...
    def configSerialize(self, opts: dict, filterSystem: bool = True):
        ...
        Args:
            opts (dict): Dictionary of ShadowTrace configuration options
    ...
    def configUnserialize(self, opts: dict, referencePoint: dict, filterSystem: bool = True):
        ...
        Args:
            opts (dict): ShadowTrace configuration options
    ...
    def urlFQDN(self, url: str) -> str:
        ...
        baseurl = ShadowTraceHelpers.urlBaseUrl(url)
        if '://' in baseurl:
            count = 2
        else:
            count = 0
    ...
    def fetchUrl(
        ...
        if sizeLimit or headOnly:
            ...
            if newloc.startswith("/") or newloc.startswith("../"):
                newloc = ShadowTraceHelpers.urlBaseUrl(url) + newloc
