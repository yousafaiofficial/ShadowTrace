...
class sfp_psbdmp(ShadowTracePlugin):
    ...
    def query(self, qry):
        ...
        res = self.sf.fetchUrl(url, timeout=15, useragent="ShadowTrace")
    ...
    def handleEvent(self, event):
        ...
        for n in data:
            e = ShadowTraceEvent("LEAKSITE_URL", n, self.__name__, event)
            ...
            evt = ShadowTraceEvent("LEAKSITE_CONTENT", res['content'], self.__name__, e)
