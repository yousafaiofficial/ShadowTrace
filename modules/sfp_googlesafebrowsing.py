...
# Purpose:      ShadowTrace plug-in to check if the URL is included on any of the
...
class sfp_googlesafebrowsing(ShadowTracePlugin):
    ...
    def query(self, qry):
        ...
        payload = {
            "client": {"clientId": "ShadowTrace", "clientVersion": "3.2"},
            "threatInfo": {
                "threatTypes": [
