...
# -------------------------------------------------------------------------------
# Name:         sfp_cookie
# Purpose:      ShadowTrace plug-in for extracting cookies from HTTP headers.
#
...
class sfp_cookie(ShadowTracePlugin):
    ...
    def handleEvent(self, event):
        ...
        if cookie:
            evt = ShadowTraceEvent("TARGET_WEB_COOKIE", cookie, self.__name__, event)
